...
var (
	// UserOrderFieldUniversity orders User by university.
	UserOrderFieldUniversity = &UserOrderField{
		Value: func(u *User) (ent.Value, error) {
			return u.University, nil
		},
		column: user.FieldUniversity,
		toTerm: user.ByUniversity,
...
func (f UserOrderField) String() string {
	var str string
	switch f.column {
	case UserOrderFieldUniversity.column:
		str = "UNIVERSITY"
	}
	return str
}
