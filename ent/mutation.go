...
func (m *OrganizationMutation) SetPriority(i int) {
	m.priority = &i
	m.addpriority = nil
}

// Priority returns the value of the "priority" field in the mutation.
func (m *OrganizationMutation) Priority() (r int, exists bool) {
	v := m.priority
	if v == nil {
		return
	}
...
// OldPriority returns the old "priority" field's value of the Organization entity.
// If the Organization object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OrganizationMutation) OldPriority(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *OrganizationMutation) AddPriority(i int) {
...
func (m *OrganizationMutation) AddedPriority() (r int, exists bool) {
	v := m.addpriority
	if v == nil {
		return
	}
...
func (m *OrganizationMutation) ResetPriority() {
	m.priority = nil
	m.addpriority = nil
}
...
func (m *OrganizationMutation) Fields() []string {
	...
	if m.priority != nil {
		fields = append(fields, organization.FieldPriority)
	}
	return fields
}
...
func (m *UserMutation) SetUniversity(s string) {
	m.university = &s
}

// University returns the value of the "university" field in the mutation.
func (m *UserMutation) University() (r string, exists bool) {
	v := m.university
	if v == nil {
		return
	}
...
// OldUniversity returns the old "university" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldUniversity(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) ResetUniversity() {
	m.university = nil
}
...
func (m *UserMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.university != nil {
		fields = append(fields, user.FieldUniversity)
	}
